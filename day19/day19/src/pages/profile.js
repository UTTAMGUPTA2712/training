...
const Profile = () => {
    ...
    const userData=useSelector(state=>state.shop.currentUser);
                ...
                <div id="profileimage">
                    <div id="profile">
                        <div id="profiledetail">
                            ...
                            <div id="edit">
                                {componentDisabled ? (
                                    <EditOutlined style={{ fontSize: "7vh" }} onClick={() => setComponentDisabled(false)} />
                                ) : (
                                    <div>
                                        <RollbackOutlined style={{ fontSize: "7vh" }} onClick={() => window.location.reload()} />
                                        {"  "} <SaveOutlined style={{ fontSize: "7vh" }} onClick={handlesave} />
                                    </div>
                                )}
                            </div>
                            <div className="topleft">
                                <h1>
                                    <input
                                        id={componentDisabled ? "" : "bordercolor"}
